...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('braja7059@gmail.com');
        setCopied(true);
                        ...
                        <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-[4px]">
                            ...
                            <div className="flex flex-col gap-3 md:gap-3 lg:gap-6">
                                {leftLists.map((item, i) => (
                                    <span
                                        key={i}
                                        className="lg:py-3 lg:px-3 py-2 px-3 text-xs lg:text-normal opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                                        {item}
                                    </span>
                                ))}
